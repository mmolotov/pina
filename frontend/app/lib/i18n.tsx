...
const enMessages = {
  ...
  // ── Admin redesign — ML / Analysis section (Part C) ─────────────────
  "app.admin.ml.title": "Analysis service",
  "app.admin.ml.sub":
    "ML pipeline observability: models, runtime profile, and the analysis queue · updated {time}",
  "app.admin.ml.refresh": "Refresh",
  "app.admin.ml.bannerTitle": "Analysis service unavailable.",
  "app.admin.ml.bannerBody":
    "New uploads are queued and processed automatically once the service is back. Already-uploaded photos remain available with no data loss.",
  "app.admin.ml.disabledTitle": "Analysis service disabled.",
  "app.admin.ml.disabledBody": "ML analysis is turned off for this instance.",
  "app.admin.ml.kpiState": "State",
  "app.admin.ml.stateReady": "Ready",
  "app.admin.ml.stateDown": "Unavailable",
  "app.admin.ml.stateDisabled": "Disabled",
  "app.admin.ml.stateDeltaReady": "gRPC responding",
  "app.admin.ml.stateDeltaDown": "no response from service",
  "app.admin.ml.stateDeltaDisabled": "PINA_ML_ENABLED=false",
  "app.admin.ml.kpiVersion": "Service version",
  "app.admin.ml.kpiVersionDelta": "ONNX runtime",
  "app.admin.ml.kpiProfile": "Active profile",
  "app.admin.ml.kpiProfileDelta": "{count} EP",
  "app.admin.ml.kpiQueue": "Queue",
  "app.admin.ml.kpiQueueSuffix": "pending",
  "app.admin.ml.kpiQueueFailed": "{count} failed",
  "app.admin.ml.modelsTitle": "Models & availability",
  "app.admin.ml.modelsSub": "{count} models across pipeline steps",
  "app.admin.ml.colStep": "Step",
  "app.admin.ml.colModel": "Model",
  "app.admin.ml.colAvailability": "Availability",
  "app.admin.ml.colLicense": "License",
  "app.admin.ml.available": "Loaded",
  "app.admin.ml.missing": "Missing",
  "app.admin.ml.commercialYes": "commercial: yes",
  "app.admin.ml.commercialNo": "commercial: no",
  "app.admin.ml.noBundling": "bundling forbidden",
  "app.admin.ml.licenseLink": "license",
  "app.admin.ml.profileTitle": "Runtime profile",
  "app.admin.ml.profileActive": "active",
  "app.admin.ml.profileMaxParallel": "max_parallel_analyses",
  "app.admin.ml.profileResolution": "Analysis resolution",
  "app.admin.ml.profileProviders": "Execution providers",
  "app.admin.ml.profileEnvNote":
    "Profile and execution-provider order are set via environment variables and applied on service restart. Read-only here.",
  "app.admin.ml.queueTitle": "Analysis queue",
  "app.admin.ml.queuePendingDelta": "in queue now",
  "app.admin.ml.queueCompletedDelta": "all time",
  "app.admin.ml.queueFailedDelta": "need attention",
  "app.admin.ml.colPhoto": "Photo",
  "app.admin.ml.colStatus": "Status",
  "app.admin.ml.colAttempts": "Attempts",
  "app.admin.ml.colNextAttempt": "Next attempt",
  "app.admin.ml.colLastError": "Last error",
  "app.admin.ml.filterAll": "All",
  "app.admin.ml.showError": "show error",
  "app.admin.ml.hideError": "hide",
  "app.admin.ml.retry": "Retry",
  "app.admin.ml.reanalyze": "Re-run",
  "app.admin.ml.queued": "queued",
  "app.admin.ml.emptyTitle": "No jobs",
  "app.admin.ml.emptyText": "No analysis jobs in this status right now.",
  "app.admin.ml.retryAllFailed": "Retry all failed",
  "app.admin.ml.retryAllTitle": "Retry all failed jobs?",
  "app.admin.ml.retryAllBtn": "Retry all",
  "app.admin.ml.retryAllCallout":
    "All FAILED jobs will be reset to PENDING and requeued for analysis.",
  "app.admin.ml.retryAllBody": "{count} will be returned to the queue.",
  "app.admin.ml.jobOne": "failed job",
  "app.admin.ml.jobFew": "failed jobs",
  "app.admin.ml.jobMany": "failed jobs",
  "app.admin.ml.jobOther": "failed jobs",
  "app.admin.ml.inferenceTitle": "Inference settings",
  "app.admin.ml.inferenceNote":
    "Parameters are set via PINA_ML_* environment variables and read-only at runtime.",
  "app.admin.ml.toastRetried": "Job queued",
  "app.admin.ml.toastReanalyzed": "Photo sent for re-analysis",
  "app.admin.ml.toastRetriedAll": "{count} returned to the queue",
  "app.admin.ml.toastRefreshed": "Data refreshed",
  "app.admin.ml.actionFailed": "Action failed.",
  "app.admin.ml.loadFailed": "Failed to load the analysis service state.",
};
...
const ruMessages: Partial<MessageCatalog> = {
  ...
  // ── Admin redesign — ML / Analysis section (Part C) ─────────────────
  "app.admin.ml.title": "Сервис анализа",
  "app.admin.ml.sub":
    "Наблюдаемость ML-пайплайна: модели, профиль рантайма и очередь анализа · обновлено {time}",
  "app.admin.ml.refresh": "Обновить",
  "app.admin.ml.bannerTitle": "Сервис анализа недоступен.",
  "app.admin.ml.bannerBody":
    "Новые загрузки ставятся в очередь и будут обработаны автоматически, когда сервис снова станет доступен. Уже загруженные фото остаются доступны без потери данных.",
  "app.admin.ml.disabledTitle": "Сервис анализа отключён.",
  "app.admin.ml.disabledBody": "Анализ ML отключён для этого инстанса.",
  "app.admin.ml.kpiState": "Состояние",
  "app.admin.ml.stateReady": "Готов",
  "app.admin.ml.stateDown": "Недоступен",
  "app.admin.ml.stateDisabled": "Отключён",
  "app.admin.ml.stateDeltaReady": "gRPC отвечает",
  "app.admin.ml.stateDeltaDown": "нет ответа от сервиса",
  "app.admin.ml.stateDeltaDisabled": "PINA_ML_ENABLED=false",
  "app.admin.ml.kpiVersion": "Версия сервиса",
  "app.admin.ml.kpiVersionDelta": "ONNX runtime",
  "app.admin.ml.kpiProfile": "Активный профиль",
  "app.admin.ml.kpiProfileDelta": "{count} EP",
  "app.admin.ml.kpiQueue": "Очередь",
  "app.admin.ml.kpiQueueSuffix": "в ожидании",
  "app.admin.ml.kpiQueueFailed": "{count} провалено",
  "app.admin.ml.modelsTitle": "Модели и доступность",
  "app.admin.ml.modelsSub": "{count} моделей по шагам пайплайна",
  "app.admin.ml.colStep": "Шаг",
  "app.admin.ml.colModel": "Модель",
  "app.admin.ml.colAvailability": "Доступность",
  "app.admin.ml.colLicense": "Лицензия",
  "app.admin.ml.available": "Загружена",
  "app.admin.ml.missing": "Отсутствует",
  "app.admin.ml.commercialYes": "коммерч.: да",
  "app.admin.ml.commercialNo": "коммерч.: нет",
  "app.admin.ml.noBundling": "бандлинг запрещён",
  "app.admin.ml.licenseLink": "лицензия",
  "app.admin.ml.profileTitle": "Рантайм-профиль",
  "app.admin.ml.profileActive": "активный",
  "app.admin.ml.profileMaxParallel": "max_parallel_analyses",
  "app.admin.ml.profileResolution": "Разрешение анализа",
  "app.admin.ml.profileProviders": "Execution providers",
  "app.admin.ml.profileEnvNote":
    "Профиль и порядок execution providers задаются переменными окружения и применяются при перезапуске сервиса. Здесь — только просмотр.",
  "app.admin.ml.queueTitle": "Очередь анализа",
  "app.admin.ml.queuePendingDelta": "в очереди сейчас",
  "app.admin.ml.queueCompletedDelta": "за всё время",
  "app.admin.ml.queueFailedDelta": "требуют внимания",
  "app.admin.ml.colPhoto": "Фото",
  "app.admin.ml.colStatus": "Статус",
  "app.admin.ml.colAttempts": "Попыток",
  "app.admin.ml.colNextAttempt": "След. попытка",
  "app.admin.ml.colLastError": "Последняя ошибка",
  "app.admin.ml.filterAll": "Все",
  "app.admin.ml.showError": "показать ошибку",
  "app.admin.ml.hideError": "скрыть",
  "app.admin.ml.retry": "Повторить",
  "app.admin.ml.reanalyze": "Заново",
  "app.admin.ml.queued": "в очереди",
  "app.admin.ml.emptyTitle": "Задач нет",
  "app.admin.ml.emptyText": "В этом статусе сейчас нет задач анализа.",
  "app.admin.ml.retryAllFailed": "Повторить все проваленные",
  "app.admin.ml.retryAllTitle": "Повторить все проваленные задачи?",
  "app.admin.ml.retryAllBtn": "Повторить все",
  "app.admin.ml.retryAllCallout":
    "Все задачи со статусом FAILED будут сброшены в PENDING и снова поставлены в очередь анализа.",
  "app.admin.ml.retryAllBody": "{count} будут возвращены в очередь.",
  "app.admin.ml.jobOne": "проваленная задача",
  "app.admin.ml.jobFew": "проваленные задачи",
  "app.admin.ml.jobMany": "проваленных задач",
  "app.admin.ml.jobOther": "проваленной задачи",
  "app.admin.ml.inferenceTitle": "Настройки инференса",
  "app.admin.ml.inferenceNote":
    "Параметры задаются переменными окружения PINA_ML_* и на рантайме доступны только для чтения.",
  "app.admin.ml.toastRetried": "Задача поставлена в очередь",
  "app.admin.ml.toastReanalyzed": "Фото отправлено на повторный анализ",
  "app.admin.ml.toastRetriedAll": "{count} возвращено в очередь",
  "app.admin.ml.toastRefreshed": "Данные обновлены",
  "app.admin.ml.actionFailed": "Не удалось выполнить действие.",
  "app.admin.ml.loadFailed": "Не удалось загрузить состояние сервиса анализа.",
};
